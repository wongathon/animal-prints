...
for (var i=0; i<defaultAnimals.length; i++){
    var b = $("<button>").attr("data-animal", defaultAnimals[i]).text(defaultAnimals[i]);
    $(".buttons-dump").append(b);
}

$(document).on("click", "#clearIt", function (event){
  console.log(defaultAnimals);
  animalsArray = defaultAnimals.slice(0);
